                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/register">
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label font-weight-bold">Name:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label font-weight-bold">E-Mail Address:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label font-weight-bold">Password:</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label font-weight-bold">Confirm Password:</label>
                            <div class="col-md-6">
